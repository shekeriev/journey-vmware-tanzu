...
$VCSAHostname = "vcsa.tanzu.lab"
$VCSAUsername = "administrator@vsphere.lab"
$VCSAPassword = '<YOUR-VCSA-PASSWORD>'
$DatacenterName = "Tanzu-Datacenter"
$DatastoreName = "datastore1"
$ClusterName = "Tanzu-Cluster"
$ESXiHostname = "esxi-micro.tanzu.lab"
$ESXiPassword = "<YOUR-ESXI-PASSWORD>"
$VDSName = "VDS"
...
$vc = Connect-VIServer $VCSAHostname -User $VCSAUsername -Password $VCSAPassword -Force
